    ...
    <div className="w-full px-20 py-8 bg-muted">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1">
          ...
          <p className="mb-8">
            Retrouvez-nous à Yopougon Maroc, Carrefour OBAMA pour discuter de
            vos besoins en transport et travaux publics.
          </p>
        ...
        <div className="flex-1 bg-muted rounded-3xl p-8 shadow-lg text-end">
          ...
          >
            ...
            <p className="text-sm text-gray-500 text-start">
              En soumettant, vous acceptez le traitement de vos données
              personnelles par nous conformément à l&apos;énoncé de
              confidentialité.
            </p>
