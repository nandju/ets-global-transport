    ...
    return(
        <div className="flex flex-col md:flex-row justify-around bg-muted p-20">
            <div className="flex flex-col justify-start items-start text-start gap-8">
                ...
                <div className="text-gray-600 text-sm md:text-xl">Des résultats qui témoignent de notre engagement et de notre <br /> expertise dans le secteur du transport et des travaux publics.</div>
