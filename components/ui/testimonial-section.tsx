...
export default function Testimonial(){
    return(
        <div className="flex flex-row justify-around bg-red-500/10 p-20">
            ...
            <div className="grid grid-cols-2 gap-8">
                <div className="flex flex-col justify-center text-primary text-center bg-white scale-105 cursor-pointer rounded-lg p-4">
